...
#include "Print.h"
#ifdef _ESP8266_
#include <SlowSoftWire.h>        // substitute for ESP8266
#else
#include <Wire.h>
#endif
#include "Arduino.h"
...
#ifdef _ESP8266_
    DigoleSerialDisp(SlowSoftWire *s, uint8_t add) //U2C set up  // STB replace for ESP8266
#else
...
private:
    ...
    uint8_t _I2Caddress;
#ifdef _ESP8266_
    SlowSoftWire *_myWire;     // replace for ESP8266
#else
    TwoWire *_myWire;
#endif
    uint8_t _Clockpin;

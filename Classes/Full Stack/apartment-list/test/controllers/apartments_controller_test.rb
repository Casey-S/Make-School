...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { address: @apartment.address, description: @apartment.description, photo_url: @apartment.photo_url, price: @apartment.price } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, description: @apartment.description, photo_url: @apartment.photo_url, price: @apartment.price } }
